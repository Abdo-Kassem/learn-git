...
@section('pageTitle') 
    <i class="fa fa-edit"></i> {{ trans('backend.edit') }} {{ trans('backend.package') }} 
@endsection
...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{ route('packages.update' , $package->id) }}" method="POST" class="userForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_ar" id="name_ar" class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" value="{{ $package->name_ar }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name_fr" id="name_fr" class="form-control {{ $errors->has('name_fr') ? 'is-invalid' : '' }}" value="{{ $package->name_fr }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" id="category_id" class="form-control select2" style="width:100%">
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ $package->category_id == $category->id ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? $category->name_ar : $category->name_fr }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6" id="days_number">
                        <div class="form-group">
                            ...
                            <input type="number" name="days_number" id="days_number" class="form-control {{ $errors->has('days_number') ? 'is-invalid' : '' }}" value="{{ $package->days_number }}" min="1">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" id="price" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" value="{{ $package->price }}">
                            @if ($errors->has('price'))
                                <span class="invalid-feedback" role="alert">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description_ar" id="description_ar" rows="4" class="form-control">{{ $package->description_ar }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description_fr" id="description_fr" rows="4" class="form-control">{{ $package->description_fr }}</textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:250px;height:200px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset($package->image) }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
