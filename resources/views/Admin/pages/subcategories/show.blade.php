...
@section('pageTitle') 
    <i class="fa fa-eye"></i> {{ trans('backend.show') }} {{ trans('backend.subcategory') }} 
@endsection
    ...
    <div class="box">
        ...
        <div class="box-header with-border">
            ...
            <div class="button-page-header" style="margin-top:5px">
                <a class="btn btn-block btn-info" href="{{ route('subcategories.edit' , $subcategory->id) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:100%;height:300px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset($subcategory->image) }}" alt="">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <h4 style="margin:0">{{ app()->getLocale()=='ar' ? $subcategory->name_ar : $subcategory->name_fr }}</h4>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>{{ trans('backend.color') }}</b></label>
                                    <h4 style="margin:0"><span style="padding:5px 30px; background-color:{{ $subcategory->color }}"></span></h4>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>{{ trans('backend.category') }}</b></label>
                                    <h4 style="margin:0">{{ app()->getLocale()=='ar' ? $subcategory->category->name_ar : $subcategory->category->name_fr }}</h4>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="first_name" style="color:#337ab7"><b>{{ trans('backend.description') }}</b></label>
                                    <h4 style="margin:0">{!! app()->getLocale()=='ar' ? $subcategory->description_ar : $subcategory->description_fr !!}</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <h4 style="margin:0">
                                        <p>{{ $subcategory->created_at->format('Y-m-d') }}</p>
                                        <p>{{ $subcategory->created_at->format('h:i A') }}</p>
                                    </h4>
                                </div>
                            </div>
			                <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <h4 style="margin:0">
                                        <p>{{ $subcategory->updated_at->format('Y-m-d') }}</p>
                                        <p>{{ $subcategory->updated_at->format('h:i A') }}</p>
                                    </h4>
                                </div>
                            </div>
                        </div>
