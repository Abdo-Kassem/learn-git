...
@section('pageTitle') 
    <i class="fa fa-plus-circle"></i> {{ trans('backend.add') }} {{ trans('backend.subcategory') }} 
@endsection
...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{ route('subcategories.store') }}" method="POST" class="userForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:100%;height:250px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset('uploads/categories/default.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
