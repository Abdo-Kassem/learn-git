...
@section('pageTitle') 
    <i class="fa fa-plus-circle"></i> {{ trans('backend.edit') }} {{ trans('backend.users') }} 
@endsection
...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{ route('admin.users.update' , $user->id) }}" method="POST" class="userForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
                ...
                <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" id="first_name" class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" value="{{ $user->first_name }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="last_name" id="last_name" class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" value="{{ $user->last_name }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="phone" id="phone" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" value="{{ $user->phone }}">
                            @if ($errors->has('phone'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <select name="city_id" id="city_id" class="form-control select2" style="width:100%">
                                ...
                                @foreach($cities as $city)
                                    <option value="{{ $city->id }}" {{ $user->city_id == $city->id ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? $city->name_ar : $city->name_fr }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="area_id" id="area_id" class="form-control select2" style="width:100%">
                                ...
                                @foreach($areas as $area)
                                    <option value="{{ $area->id }}" {{ $user->area_id == $area->id ? 'selected' : '' }}>{{ app()->getLocale() == 'ar' ? $area->name_ar : $area->name_fr }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:200px;height:160px;margin-top:5px" class="image-preview img-thumbnail" src="{{ asset($user->avatar) }}" alt="">
                            </div>
                        </div>
                    </div>
