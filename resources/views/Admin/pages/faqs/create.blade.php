...
@section('pageTitle') 
    <i class="fa fa-plus-circle"></i> {{ trans('backend.add') }} {{ trans('backend.faq') }} 
@endsection
...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <form id="myForm" action="{{ route('admin.pages.faqs.store') }}" method="POST" class="userForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('POST') }}
                ...
                <div class="row">    
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="question_ar" id="question_ar" class="form-control {{ $errors->has('question_ar') ? 'is-invalid' : '' }}" value="{{ old('question_ar') }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="question_en" id="question_en" class="form-control {{ $errors->has('question_en') ? 'is-invalid' : '' }}" value="{{ old('question_en') }}">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea  name="answer_ar" id="answer_ar" rows="5" class="form-control {{ $errors->has('answer_ar') ? 'is-invalid' : '' }}">{{ old('answer_ar') }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea  name="answer_en" id="answer_en" rows="5" class="form-control {{ $errors->has('answer_en') ? 'is-invalid' : '' }}">{{ old('answer_en') }}</textarea>
...
$(document).ready(function(){
  ...
  $('#myForm').validate({
      rules : {
        question_ar : { required : true},
        question_en : { required : true },
        answer_ar : { required : true},
        answer_en : { required : true},
      },
      messages : {
